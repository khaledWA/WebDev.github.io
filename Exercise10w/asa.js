	...
	["horseright", "", "animate2", "", "rider",
	 ...
	 ["flag", "fenceup", "animate2", "", "",
 	 ...
 	 "rider", "rock", "animate2", "tree", "",
  	 ...
  	 ["flag", "fenceup", "animate3", "animate3", "",
  	 "rock", "water", "bridge", "water", "water",
 	 "rider", "", "", "", "",
...
function levelUp(nextClass) {
	...
	}else if (nextClass == "girl" && riderOn) {
		document.getElementById("gameOver").style.display = "block";
	}
}
...
//load levels 0 - max level
 function loadLevel() {
 	...
 	animateEnemy(animateBoxes, 2, "right");
...
function playAgain() {
	...
	window.clearInterval(currentAnimation);
	window.clearInterval(currentAnimation2);
	document.getElementById("lose").style.display = "none";/*******the visibility of lose is done differently in this game (it doesn't use classes hidden/unhidden) ***/
	document.getElementById("gameOver").style.display="none";
	currentLevel = 0;
	loadLevel();
	//levelUp(nextClass);   /********I removed this bcs it was creating an error and not doing anything************/
